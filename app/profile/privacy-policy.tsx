      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.sectionCard}>
          ...
          <Text style={styles.text}>
            We may collect your name, email, phone number, address, service requests, booking
        ...
        <View style={styles.sectionCard}>
          ...
          <Text style={styles.text}>
            To provide and improve services, process bookings, communicate updates, analyze usage, and
